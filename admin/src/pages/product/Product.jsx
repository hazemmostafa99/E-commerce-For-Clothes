    ...
    const getStats = async () => {
      ...
      data.map((stats) => {
        return setStats((prev) => {
          return [...prev, { name: Months[stats._id - 1], Sales: stats.total }];
        });
      });
    };
    getStats();
      ...
      uploadTask.on(
        ...
        () => {
          ...
          getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
            const product = { ...myProduct, img: downloadURL };
            updateProduct(dispatch, id, product);
          });
        }
      );
    } else {
      updateProduct(dispatch, id, myProduct);
    }
  };
      ...
      <div className="productBottom">
        <form className="productForm">
          <div className="productFormLeft">
            ...
            <select name="inStock" id="idStock" onChange={handelProduct}>
          ...
          <div className="productFormRight">
            ...
            <button className="productButton" onClick={handelUpdate}>
              Update
            </button>
          </div>
        </form>
